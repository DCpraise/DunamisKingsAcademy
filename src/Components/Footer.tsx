    ...
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
                <div className="md:max-w-96">
                    <img width={200} height={40} src={logo} alt="Dunamis Kings Logo" />
                    ...
                    <p className="mt-6 text-sm">
                        Dunamis Kings Academy
                        Raising future leaders with excellence, integrity, and love.
                        We are committed to providing a safe, nurturing, and inspiring learning environment where every child can thrive academically, socially, and spiritually.
                    </p>
                </div>
                <div className="flex-1 flex items-start md:justify-end gap-20">
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-2">
                           <p> 📍 Address: #1 Osuachala Close, Opposite Okwadike Filling Station, Melsanah Junction, Akpuoga Nike along Abakaliki Road, Enugu, Enugu State </p>
                            <p>📞 Phone: 08063481541, 07065212099 </p>
                            <p>📧 Email: dunamiskings@gamil.com </p>
                        </div>
                    </div>
                </div>
            </div>
            <p className="pt-4 text-center text-xs md:text-sm pb-5">
            © {new Date().getFullYear()} Dunamis Kings Academy. All rights reserved.
